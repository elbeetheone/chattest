...
if bar == st.secrets['BAR_4']:
 ...
 'key_1': '⭐⭐⭐⭐☆ (4.5/5)',
 'key_2': ['Adding a concrete example of an impactful project or achievement.',
  'Smoother transitions between sections for better flow.',
  'A brief mention of the company or role to tailor the response more.'],
 'key_3': 'For example, in my previous role, I worked on a project that improved our data reporting efficiency by 30% by automating a key process. That experience solidified my interest in using data for decision-making, which is why I pursued additional training in data science.'}
